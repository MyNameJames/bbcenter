...
## 11. Gotchas ระดับ implementation

> ย้ายมาจาก `CLAUDE.md` § Gotchas (2026-07-31, /doctor check 4) — เฉพาะจุด vehicle-domain ล้วน ส่วนที่ใช้ร่วมทุก domain (Thai time / models package / DB migration / Telegram pattern) ยังอยู่ที่ `CLAUDE.md` เหมือนเดิม
